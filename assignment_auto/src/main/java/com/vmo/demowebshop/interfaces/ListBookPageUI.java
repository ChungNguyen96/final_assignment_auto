...
public class ListBookPageUI {
    ...
    public static final String LISTBOOKS_TITLE = "//div[@class='product-item']//h2[@class='product-title']";
    public static final String LISTBOOK_TITLE = "//div[@class='product-item']//h2[@class='product-title']/a[text()='%s']";
    ...
    public static final String BTN_ADD_TO_CART_BY_RATE = "//div[@class='rating']/div[contains(@style,'59')]/ancestor::div[@class='details']//input";
    ...
    public static final String BOOK_NAME_IN_MINI_CART = "//div[@class='mini-shopping-cart']//div[@class='name']/a";
