...
public class BasePage {
    ...
    protected WebDriverWait explicit;
    ...
    protected void switchToWindowByURL(WebDriver driver, String url) {
        Set<String> allWindows = driver.getWindowHandles();
        for (String id : allWindows) {
            driver.switchTo().window(id);
    ...
    protected List<WebElement> getListOptionInDropdownList(WebDriver driver,String locator){
        select = new Select(getWebElement(driver, locator));
        return select.getOptions();
    }
    protected boolean verifySort(List<String> listName){

        Iterator<String> iter = listName.iterator();
